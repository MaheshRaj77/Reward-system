    ...
    useEffect(() => {
        const loadReward = async () => {
            try {
                ...
                // Verify the reward belongs to the parent's family
                if (data.familyId !== parent.familyId) {
                    setNotFound(true);
                    setLoading(false);
                    return;
                }
        ...
        return (
            <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 flex items-center justify-center">
                <div className="text-center">
                    ...
                    <p className="text-gray-600 mb-6">This reward doesn&apos;t exist or you don&apos;t have access to it.</p>
                    <Link href="/rewards">
