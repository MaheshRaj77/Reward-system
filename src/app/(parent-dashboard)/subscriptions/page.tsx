  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-pink-50 to-orange-50">
      ...
      <ConfirmDialog
        ...
        message="You will lose access to all premium features including unlimited children, recurring tasks, and advanced features. Your subscription will remain active until the end of your current billing period."
